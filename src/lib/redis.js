...
const rSIsMember = promisify(redisClient.sismember).bind(redisClient);
// const rMSIsMember = promisify(redisClient.smismember).bind(redisClient); //not available in current node-redis release
 
module.exports = {rGet, rSet, rHGet, rHGetAll, rHSet, rHIncrBy, rExists, rSAdd, rSIsMember};